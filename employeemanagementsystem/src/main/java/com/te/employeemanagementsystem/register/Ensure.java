...
public final class Ensure {
	...
	public static Info ensureInfo(Scanner sc) {
	...
	public static void ensureDate(String str) throws ColumnConditionFailedException, NotLegalToWorkException, IllegalDateException {
